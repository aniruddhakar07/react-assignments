    ...
    <div>
      <div className="page-header">
        <div className="page-title-group">
          ...
          <p>Protected archive of closed tasks with restoration controls.</p>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
              {tasks.length > 0 
                ? `${Math.round((completedTasks.length / tasks.length) * 100)}% completion velocity` 
                : 'No tasks registered'}
            </p>
          </div>
        </div>
      ...
      {completedTasks.length > 0 ? (
        ...
        <div className="empty-state">
          ...
          <p className="empty-desc">
            Tasks marked as "Closed" are automatically archived in this secure repository.
          </p>
