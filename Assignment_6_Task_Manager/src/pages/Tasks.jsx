    ...
    <div>
      ...
      <div className="page-header">
        <div className="page-title-group">
          ...
          <p>Browse, organize, filter, and track all tasks with URL state synchronization.</p>
        </div>
      ...
      {filteredTasks.length > 0 ? (
        ...
        <div className="empty-state">
          ...
          <p className="empty-desc">
            Try adjusting your search criteria or clearing filters to see more tasks.
          </p>
      ...
      <Modal
        ...
        title="Delete Task"
        message={`Are you sure you want to delete "${taskToDelete?.header}"? This action cannot be undone.`}
