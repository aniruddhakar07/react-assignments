...
export const AddTask = () => {
  ...
  // Current system timestamp preview for "Raised Date and Time: Automatically picked"
  const now = new Date();
  ...
  const handleSubmit = (e) => {
    ...
    // Programmatic navigation with React Router to dynamic route /tasks/:id
    ...
    <div>
      ...
      <div className="page-header" style={{ maxWidth: '780px', margin: '0 auto 2rem auto' }}>
        <div className="page-title-group">
          ...
          <p>Fill in task parameters. Raised timestamp is stamped automatically.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <span className="form-help">Urgency classification</span>
            </div>
            ...
            <div className="form-group">
              ...
              <span className="form-help">Work domain partition</span>
            </div>

            {/* Raised Date and Time: Automatically picked (Constraint in syllabus) */}
            <div className="form-group">
              ...
              <span className="form-help">Automatically stamped upon submission</span>
            </div>

            {/* Due Date: User selectable */}
            <div className="form-group">
            ...
            <div className="form-group col-span-2">
              ...
              >
                <option value="Raised">Raised (Default new item)</option>
